 ...
 * transaction. Critically, the insert always happens IN THE SAME transaction as the business
 * outcome it marks (either the successful reservation, or the recorded failure) - never as a
 * separate up-front step - so a crash between "marked processed" and "business work done" is
 * impossible to observe: either both commit together, or neither does. See
