...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<OrderCreatedPayload>> orderCreatedContainerFactory(
            KafkaTemplate<Object, Object> deadLetterKafkaTemplate) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<OrderCreatedPayload>>();
