 ...
 * The insert always happens IN THE SAME transaction as the business outcome it marks (the payment
 * decision + outbox write) - never as a separate up-front step - so a crash between "marked
