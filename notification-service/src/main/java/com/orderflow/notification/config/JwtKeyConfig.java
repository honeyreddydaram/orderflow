...
/**
 * Notification Service only ever verifies tokens issued by Auth Service - it loads the RSA PUBLIC
 * key only, never a private key, and never signs anything. See docs/architecture.md section 13.
 */
@Configuration
