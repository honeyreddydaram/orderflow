...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<InventoryReservationFailedPayload>> inventoryReservationFailedContainerFactory(
            KafkaTemplate<Object, Object> deadLetterKafkaTemplate) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<InventoryReservationFailedPayload>>();
        factory.setConsumerFactory(consumerFactory(new TypeReference<>() {
        }));
        factory.setCommonErrorHandler(errorHandler(deadLetterKafkaTemplate));
        return factory;
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<PaymentCompletedPayload>> paymentCompletedContainerFactory(
            KafkaTemplate<Object, Object> deadLetterKafkaTemplate) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<PaymentCompletedPayload>>();
        factory.setConsumerFactory(consumerFactory(new TypeReference<>() {
        }));
        factory.setCommonErrorHandler(errorHandler(deadLetterKafkaTemplate));
        return factory;
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<PaymentFailedPayload>> paymentFailedContainerFactory(
            KafkaTemplate<Object, Object> deadLetterKafkaTemplate) {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, EventEnvelope<PaymentFailedPayload>>();
        factory.setConsumerFactory(consumerFactory(new TypeReference<>() {
        }));
        factory.setCommonErrorHandler(errorHandler(deadLetterKafkaTemplate));
        return factory;
