...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleUpstream(UpstreamServiceException ex, HttpServletRequest request) {
        ...
        return respond(HttpStatus.BAD_GATEWAY, "Bad Gateway", "A required upstream service is unavailable", request);
    }

    @ExceptionHandler(IdempotencyKeyInProgressException.class)
    public ResponseEntity<ApiError> handleIdempotencyInProgress(IdempotencyKeyInProgressException ex, HttpServletRequest request) {
